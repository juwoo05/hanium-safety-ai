...
<header class="sticky top-0 z-40 border-b border-slate-200/80 bg-white/95 backdrop-blur">
  <div class="max-w-7xl mx-auto px-5 sm:px-6 h-16 flex items-center justify-between">
    <div class="flex items-center gap-2">
      <img src="/images/yeongyeol-gori-logo.png" alt="연결고리 로고" class="w-10 h-10 object-contain"/>
      <span class="font-bold text-xl text-[#1A2E44]">연결고리</span>
    </div>
...
<!-- Hero Section -->
<section class="max-w-7xl mx-auto px-5 sm:px-6 py-14 lg:py-20">
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    <div>
      <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 border border-blue-100 rounded-full mb-5">
        <span class="w-2 h-2 rounded-full bg-[#FF7A00]"></span>
        <span class="text-[#086CF0] font-semibold text-sm">AI 기반 현장 안전 솔루션</span>
      </div>
      <h1 class="text-4xl lg:text-5xl font-bold text-[#1A2E44] mb-6 leading-tight">
      ...
      <div class="flex flex-col sm:flex-row gap-3 mb-8">
        <a href="/upload" class="px-7 py-3.5 bg-[#1A2E44] text-white text-base font-semibold rounded-lg hover:bg-[#0F2233] transition-colors shadow-md">현장 사진 분석하기</a>
        <a href="/dashboard" class="px-7 py-3.5 border border-slate-300 text-[#1A2E44] text-base font-semibold rounded-lg hover:border-[#1A2E44] hover:bg-slate-50 transition-colors">대시보드 보기</a>
      </div>
    ...
    <div class="relative">
      <div style="background:#EEF3F8;border:1px solid #E2E8F0;border-radius:8px;padding:32px">
        <div class="flex flex-col items-center gap-3 mb-6">
          <img src="/images/mascot.png" alt="연결고리 안전 도우미" class="w-32 h-32 object-contain" style="filter:drop-shadow(0 6px 14px rgba(15,32,56,0.22))"/>
        ...
        <div class="bg-white rounded-lg p-6 shadow-sm" style="border:1px solid #E2E8F0">
...
<section class="container mx-auto px-6 py-20">
  <div class="text-center mb-16">
    <h2 class="text-4xl font-bold text-[#1A2E44] mb-4">연결고리를 선택해야 하는 이유</h2>
    <p class="text-xl text-gray-600">AI 기술로 현장 안전 관리가 달라집니다</p>
  </div>
  <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
    <div class="bg-white rounded-lg p-8 border border-slate-200 shadow-sm hover:shadow-md transition-shadow text-center">
      <div class="w-20 h-20 bg-blue-500 rounded-lg flex items-center justify-center mx-auto mb-6"><span class="text-3xl font-bold text-white">70%</span></div>
      <h3 class="text-2xl font-bold text-[#1A2E44] mb-3">시간 절약</h3>
      <p class="text-gray-600">수작업 점검 대비 70% 이상 시간 단축</p>
    </div>
    <div class="bg-white rounded-lg p-8 border border-slate-200 shadow-sm hover:shadow-md transition-shadow text-center">
      <div class="w-20 h-20 bg-[#FF7A00] rounded-lg flex items-center justify-center mx-auto mb-6"><span class="text-3xl font-bold text-white">60%</span></div>
      <h3 class="text-2xl font-bold text-[#1A2E44] mb-3">비용 절감</h3>
      <p class="text-gray-600">사고 예방으로 평균 60% 비용 감소</p>
    </div>
    <div class="bg-white rounded-lg p-8 border border-slate-200 shadow-sm hover:shadow-md transition-shadow text-center">
      <div class="w-20 h-20 bg-[#1A2E44] rounded-lg flex items-center justify-center mx-auto mb-6"><span class="text-3xl font-bold text-white">98%</span></div>
...
<section class="bg-slate-50 border-y border-slate-200 py-20">
  <div class="container mx-auto px-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
      <div class="bg-white rounded-lg p-8 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
...
<!-- Features -->
<section class="container mx-auto px-6 py-20">
  <h2 class="text-4xl font-bold text-[#1A2E44] text-center mb-4">연결고리의 핵심 기능</h2>
...
<section class="bg-[#1A2E44] py-20" style="border-top:4px solid #FF7A00">
  <div class="container mx-auto px-6 text-center">
    <div class="flex flex-col items-center gap-3 mb-8">
      <img src="/images/mascot.png" alt="연결고리 마스코트" class="w-32 h-32 object-contain" style="filter:drop-shadow(0 6px 14px rgba(15,32,56,0.22))"/>
      <div class="relative bg-white rounded-2xl shadow-lg px-4 py-3 max-w-xs">
        <div class="absolute -top-2 left-1/2 -translate-x-1/2 w-0 h-0 border-l-8 border-r-8 border-b-8 border-l-transparent border-r-transparent border-b-white"></div>
        <p class="text-sm text-gray-700">오늘은 고위험 항목 3건을 먼저 확인해보세요</p>
      </div>
    </div>
    <h2 class="text-4xl font-bold text-white mb-6">지금 바로 연결고리를 시작하세요</h2>
    ...
    <div class="flex items-center justify-center gap-4">
      <a href="/signup" class="px-9 py-4 bg-[#FF7A00] text-white text-lg font-semibold rounded-lg hover:bg-[#E96F00] transition-colors shadow-lg">무료로 시작하기</a>
      <a href="/login" class="px-9 py-4 bg-white text-[#1A2E44] text-lg font-semibold rounded-lg hover:bg-slate-100 transition-colors shadow-md">로그인하기</a>
    </div>
  </div>
</section>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
      <div class="md:col-span-1">
        <div class="flex items-center gap-2 mb-4">
          <img src="/images/yeongyeol-gori-logo.png" alt="연결고리 로고" class="w-10 h-10 object-contain"/>
          <span class="font-bold text-xl">연결고리</span>
        </div>
        <p class="text-gray-300 mb-4">AI가 지켜주는<br/>현장 안전 관리 시스템</p>
        <p class="text-gray-400 text-sm">© 2026 연결고리.<br/>All rights reserved.</p>
      </div>
      <div>
    ...
    <div class="border-t border-white/10 pt-8">
      <div class="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div class="flex items-center gap-4">
          ...
          <span class="text-gray-400 text-sm">support@yeongyeolgori.kr</span>
        </div>
      </div>
    </div>
  </div>
