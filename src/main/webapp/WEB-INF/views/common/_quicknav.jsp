...
<div id="quickNav" class="fixed bottom-5 left-1/2 z-50 flex flex-col items-center gap-2" style="transform:translateX(-50%)">
  <div id="quickNavPanel" style="background:rgba(15,23,42,0.92);backdrop-filter:blur(12px);border-radius:8px;border:1px solid rgba(255,255,255,0.08);box-shadow:0 8px 32px rgba(0,0,0,0.3);padding:6px 8px">
    <div class="flex items-center" style="gap:2px">
      <a href="/dashboard" class="quicknav-item" data-path="dashboard" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;text-decoration:none">
      ...
      <a href="/upload" class="quicknav-item" data-path="upload" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;text-decoration:none">
      ...
      <a href="/actions" class="quicknav-item" data-path="actions" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;text-decoration:none">
      ...
      <a href="/analytics" class="quicknav-item" data-path="analytics" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;text-decoration:none">
      ...
      <a href="/notifications" class="quicknav-item" data-path="notifications" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;text-decoration:none">
      ...
      <a href="/report-board" class="quicknav-item" data-path="report-board" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;text-decoration:none">
      ...
      <a href="/mypage" class="quicknav-item" data-path="mypage" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;text-decoration:none">
...
.quicknav-item span { transition: font-weight .12s; }
.quicknav-item svg { transition: stroke-width .12s; }
