...
<div id="quickNav" class="fixed bottom-5 left-1/2 z-50 flex flex-col items-center gap-2" style="transform:translateX(-50%)">
  <div id="quickNavPanel" style="background:rgba(15,23,42,0.92);backdrop-filter:blur(12px);border-radius:8px;border:1px solid rgba(255,255,255,0.08);box-shadow:0 8px 32px rgba(0,0,0,0.3);padding:6px 8px">
    <div class="flex items-center" style="gap:2px">
      <a href="/dashboard" class="quicknav-item" data-path="dashboard" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;color:#6B7E94;text-decoration:none">
      ...
      <a href="/upload" class="quicknav-item" data-path="upload" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;color:#6B7E94;text-decoration:none">
      ...
      <a href="/actions" class="quicknav-item" data-path="actions" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;color:#6B7E94;text-decoration:none">
      ...
      <a href="/actions/detail" class="quicknav-item" data-path="actions-detail" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;color:#6B7E94;text-decoration:none">
      ...
      <a href="/analytics" class="quicknav-item" data-path="analytics" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;color:#6B7E94;text-decoration:none">
      ...
      <a href="/notifications" class="quicknav-item" data-path="notifications" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;color:#6B7E94;text-decoration:none">
      ...
      <a href="/report-board" class="quicknav-item" data-path="report-board" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;color:#6B7E94;text-decoration:none">
      ...
      <a href="/mypage" class="quicknav-item" data-path="mypage" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:5px 8px;border-radius:4px;color:#6B7E94;text-decoration:none">
  ...
  <button type="button" id="quickNavToggle" style="background:rgba(15,23,42,0.85);backdrop-filter:blur(8px);border:1px solid rgba(255,255,255,0.08);border-radius:20px;padding:4px 12px;display:flex;align-items:center;gap:4px;font-size:10px;font-weight:500;color:#6B7E94;cursor:pointer">
...
<style>
.quicknav-item:hover { background: rgba(255,255,255,0.05); color: #94A3B8; }
.quicknav-item.active { background: rgba(74,144,217,0.18); color: #5CA8E8; }
</style>
