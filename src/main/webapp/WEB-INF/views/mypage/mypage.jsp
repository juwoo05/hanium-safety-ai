    ...
    <div class="max-w-4xl mx-auto space-y-6">
      ...
      <div class="flex justify-center">
        <form action="/logout" method="post">
          ...
          <button type="submit" class="flex items-center gap-2 px-6 py-2.5 border border-gray-300 text-gray-600 rounded-xl text-sm font-medium hover:bg-gray-50 hover:border-gray-400 transition-colors">
