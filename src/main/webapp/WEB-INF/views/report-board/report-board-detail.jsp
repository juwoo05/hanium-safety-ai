    ...
    <div class="max-w-4xl mx-auto space-y-5">
      ...
      <div class="bg-white rounded p-6 shadow-sm border border-gray-100">
        <div class="flex items-start justify-between gap-4 mb-4">
          <div class="flex items-start gap-3 flex-1">
            <div class="w-10 h-10 bg-red-50 rounded flex items-center justify-center flex-shrink-0 mt-0.5">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div class="lg:col-span-2 space-y-5">
          ...
          <div class="bg-white rounded p-6 shadow-sm border border-gray-100">
            <h2 class="text-base font-bold text-gray-900 mb-4 flex items-center gap-2">
              <svg class="w-4 h-4 text-[#1A2E44]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
            ...
            <div class="space-y-4 mb-5">
              ...
              <c:forEach var="c" items="${comments}">
                <div class="p-4 rounded border ${c.official ? 'bg-blue-50 border-blue-100' : 'bg-gray-50 border-gray-100'}">
        ...
        <div class="space-y-5">
              ...
              <c:forEach var="t" items="${timelines}" varStatus="status">
                <div class="flex gap-3">
                  <div class="flex flex-col items-center">
                    <div class="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 ${t.done ? 'bg-[#1A2E44] text-white' : 'bg-gray-100 border-2 border-gray-200'}">
                      <c:choose>
                        <c:when test="${t.done}">
                    ...
                    <c:if test="${!status.last}">
                      <div class="w-0.5 flex-1 mt-1 min-h-[20px] ${t.done ? 'bg-[#1A2E44]/30' : 'bg-gray-100'}"></div>
                    </c:if>
                  </div>
                  <div class="pb-4">
          ...
          <!-- Report info -->
          <div class="bg-white rounded p-5 shadow-sm border border-gray-100 space-y-3">
          ...
          <!-- Notice -->
          <div class="bg-blue-50 rounded p-4 border border-blue-100 text-xs text-blue-700">
